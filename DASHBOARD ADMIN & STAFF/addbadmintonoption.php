										...
										<div class="tab height-100-p">
														...
														<form action="" method="POST">
															<ul class="profile-edit-list row">
																<li class="weight-500 col-md-6">
                                                                    ...
                                                                    <input class="form-control form-control-lg" type="time" name="timeid" ><br>
                                                                    </div>
                                                                    <div class="form-group">
                                                                    <label for="timevalue">Time Value</label>
                                                                    <input class="form-control form-control-lg" type="text" name="timevalue" ><br>
                                                                    </div>
														...
														<form action="" method="POST">
															<ul class="profile-edit-list row">
																<li class="weight-500 col-md-6">
                                                                    ...
                                                                    <input class="form-control form-control-lg" type="int" name="durationid" ><br>
                                                                    </div>
                                                                    <div class="form-group">
                                                                    <label for="durationvalue">Duration Value</label>
                                                                    <input class="form-control form-control-lg" type="text" name="durationvalue" ><br>
                                                                    </div>
											...
											<?php
												...
												if (isset($_POST['addTimeOption'])) {
													...
													// mysqli_stmt_bind_param($stmt, "ss", $timeId, $timeValue);
												...
												// $stmt = mysqli_prepare($mysqli, $sqlquery);
												// mysqli_stmt_bind_param($stmt, "ss", $durationId, $durationValue);
